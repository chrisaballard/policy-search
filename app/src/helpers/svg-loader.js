export function setUpLoader() {
	...
	function createPointRadar(radius){
		...
		obj.setAttributeNS(null, 'stroke', "#ccc");
	...
	function createBulletRadar(group, radius, half){
		if(half){
			...
			bullet.setAttributeNS(null, 'fill', "#ccc");
		...
		bullet2.setAttributeNS(null, 'fill', "#ccc");
	...
	if(half){
		...
		bullet3.setAttributeNS(null, 'fill', "#ccc");
		...
		bullet4.setAttributeNS(null, 'fill', "#ccc");
