  ...
  return (
    <div className="mr-6">
      <span className="relative inline-block cursor-pointer">
        ...
        <span className={`inline-block border text-center align-top overflow-hidden rounded transition duration-300 ${checked ? 'border-primary-light bg-primary-light text-white' : 'border-primary bg-white'}`} style={{ height: '24px', width: '24px'}}>
